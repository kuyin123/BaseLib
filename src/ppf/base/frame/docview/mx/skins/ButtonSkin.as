package ppf.base.frame.docview.mx.skins
{
...
//						{ x: 1, y: 1, w: w - 2, h: h - 2, r: cornerRadius - 1 });
			...
			graphics.moveTo(w*0.25, h*0.25);
			graphics.lineTo(w *0.5, h *0.6);
			graphics.lineTo(w *0.75, h*0.25);
			graphics.lineTo(w*0.25, h*0.25);
			graphics.endFill();
		}
