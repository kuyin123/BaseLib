...
{
	import ppf.base.frame.docview.mx.views.events.ViewEvent;
	...
	public class DockViewDividedBox extends DividedBox
	{
		/**
		 * 是否使用 HtmlTest显示
		 */		
		...
		public function DockViewDividedBox()
		{
			super();
			...
			/** effects */ /** events */
			this.addEventListener(ViewEvent.CLOSED, onViewClosed);
...
//			this.setStyle("verticalGap", 0);
			...
			/** other */
			this.addEventListener(FlexEvent.CREATION_COMPLETE,onCreateComplete,false,0,true);
		}
		public function onViewClosed(event:ViewEvent):void
		{
			dispose();
		}
		...
		private var _showTopControl:Boolean = true;
	}
}